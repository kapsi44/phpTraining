...
{
    $type = "text";
    echo "<input type='$type'  id='$id' placeholder='$name' name='$id' class='$class'  tabindex='$tabindex' required='true' /> ";
...
function inputMobile($id, $name, $tabindex, $class = "form-control input-lg")
{
	$type = "text";
	echo "<input type= '$type' id='$id' placeholder='$name' name='$id' class='$class'  tabindex='$tabindex' MaxLength='10' /> ";
}
